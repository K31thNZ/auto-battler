...
db.exec(`
  CREATE TABLE IF NOT EXISTS socketed_shards (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    player_creature_id INTEGER NOT NULL,
    slot_index INTEGER NOT NULL,
    element TEXT NOT NULL,
    purity INTEGER NOT NULL DEFAULT 1,
    slot_type TEXT NOT NULL DEFAULT 'boost',
...
db.exec(`
  CREATE TABLE IF NOT EXISTS shard_purity_wallet (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    player_id INTEGER NOT NULL,
    element TEXT NOT NULL,
    purity INTEGER NOT NULL DEFAULT 1,
    quantity INTEGER DEFAULT 0,
    UNIQUE(player_id, element, purity),
    FOREIGN KEY (player_id) REFERENCES players(id)
  );
`);
